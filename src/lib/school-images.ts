/** Local school photos in /public/gallery — hero slideshow & visit-form.jpg are separate. */
export const SCHOOL_IMAGES = {
  ...
  graduationPerformance: "/gallery/bieu-dien-tot-nghiep.jpg",
